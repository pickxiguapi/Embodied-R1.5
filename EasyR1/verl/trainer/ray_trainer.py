...
from ..utils.checkpoint import (CHECKPOINT_TRACKER, find_latest_ckpt,
...
from .core_algos import (AdvantageEstimator, FixedKLController, KLController,
                         compute_advantage_return, compute_kl,
                         get_kl_controller)
from .metrics import (compute_data_metrics, compute_length_metrics,
...
class RayPPOTrainer:
    ...
    def _validate(self) -> dict[str, Any]:
        ...
        print(f"Average overall score: {val_reward_metrics.get('val/overall_reward', 'N/A')}")
    ...
    def _make_batch_data(self, metrics: dict[str, Any]) -> DataProto:
        ...
        while True:
            ...
            if self.config.algorithm.online_filtering:
                ...
                # print(f"[DEBUG] filter_scores: {filter_scores}, filter_low: {self.config.algorithm.filter_low}, filter_high: {self.config.algorithm.filter_high}")
    ...
    def fit(self):
        ...
        while self.global_step < self.training_steps:
            ...
            with timer("step", timing_raw):
                ...
                #     else:
                #         print("[DEBUG] step20 dump skipped: dataset_name/problem_id not found in non_tensor_batch")
